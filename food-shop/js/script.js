...
jQuery(function ($) {
    ...
    $(".best-products-carousel").on('changed.owl.carousel', function(e) {
        if (!e.namespace)  {
          return;
        }
    ...
    //Testimonial Slider
    $(".testimonial-carousel").on('changed.owl.carousel', function(e) {
        if (!e.namespace)  {
          return;
        }
        var carousel = e.relatedTarget;
        // console.log(e)
        $('.slider-counter-press').text(carousel.relative(carousel.current()) + 1 + '/' + carousel.items().length);
    })
    // $(".testimonial-carousel").on('translated.owl.carousel', function(event) {
    ...
    $('.testimonial-carousel').owlCarousel({
        ...
        nav: true,
        center:true,
        // navText: ["<div class='mt-20'><span class='image-caption text-gray2' style='font-size: 20px; padding-right: 30px; font-weight: 500;'></span><i class='las la-angle-left'></i> <span class='slider-counter-press'></span>","<i class='las la-angle-right'></i></div>"],
        navText: ["<div class='mt-20'><i class='las la-angle-left'></i> <span class='slider-counter-press'></span>","<i class='las la-angle-right'></i></div>"],
        onInitialized: function(e) {
            $(".owl-nav").find('.slider-counter-press').text((e.page.count+1)+ '/' + e.item.count);
            // var activeImg = $('.testimonial-carousel').find('.active').find('img');
            // var title = activeImg.attr('title');
            // $(".owl-nav").find('.image-caption').html(title);   
        },
        autoplay: true,
        margin:0,
        autoplayHoverPause: true,
